...
2. In the BE repo, run `npm install` to install packages, then run `docker-compose -f local-auth-setup.yml up` to run the BE locally and do the database migrations.
